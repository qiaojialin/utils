...
public class Point implements Serializable {
  ...
  public Point(String user, String password, String imei, long time, Map<String, Float> values) {
    this.user = user;
  ...
  public static void register() {
    String url = "http://localhost:8083/api/ios/registerPhone";
    try {
  ...
  public static void insertData() {
    ...
    values.put("s3", 0.1f);
    Point point = new Point("gou", "aaa", "phone2", 1L, values);
    String url = "http://localhost:8083/api/ios/addDatum";
