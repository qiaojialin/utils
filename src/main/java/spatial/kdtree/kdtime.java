package spatial.kdtree;// illustrates differences between KD tree search and exhaustive search
...
//对比kdtree和线性搜索的耗时，点查询和最近邻查询
class kdtime {

    public static void main(String [] args) {

    	//20个2维的数据，查询次数1，第四个候选参数是随机种子
    	args = new String[]{"10000000", "2", "1"};
