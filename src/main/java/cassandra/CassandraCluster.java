...
public class CassandraCluster {
    ...
    static private String createSTIndexCfCql = "CREATE TABLE IF NOT EXISTS %s.%s (" + "rowkey int," + "geohash bigint,"
            + "value blob," + "PRIMARY KEY(rowkey,geohash)" + ");";
    ...
    private static int confConsistency = 1;
